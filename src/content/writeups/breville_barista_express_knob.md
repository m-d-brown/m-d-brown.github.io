...
mechanism restores smooth operation and takes only a few minutes.

## What you'll need

- Food-safe synthetic lubricant with a needle-nose applicator (e.g.
  [Super Lube Synthetic Oil](https://www.super-lube.com/synthetic-oil))
- A soft-grip tool such as a quick clamp with rubber pads (for leverage when
  pulling the knob)
...
The steam/hot water selector knob is on the right side of the machine. It
...
must release. You may need to wiggle the knob side-to-side slightly as you pull
...
With the knob removed you can see the valve assembly. The red arrows in the
...
Push the knob straight back onto the valve stem, which will re-engage the spring
clip. Rotate the knob through all three positions (steam → standby → hot water)
to ensure the selector is functional and turns smoothly.
